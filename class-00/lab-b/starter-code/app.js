...
// "this" is referring to the object of joe as stated earlier in the code when the Constructor was set.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" is invoking the window since arrow functions cannot access a "this" in a Constructor.
// 3. Explain why "this" is different when an arrow function is used.
// it is different because it is accessing the window in which joe is defined.
